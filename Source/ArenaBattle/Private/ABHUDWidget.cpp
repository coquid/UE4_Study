...
void UABHUDWidget::BindCharacterStat(class UABCharacterStatComponent* CharacterStatComp)
{
	ABCHECK(CharacterStatComp != nullptr);
	CurrentCharacterStat = CharacterStatComp;
	CharacterStatComp->OnHPChanged.AddUObject(this, &UABHUDWidget::UpdateCharacterStat);
}
...
{
	ABCHECK(CurrentPlayerState != nullptr);
